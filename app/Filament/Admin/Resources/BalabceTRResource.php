...
class BalabceTRResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return auth()->user()->hasPermissionTo('view_balabce::t::r');

    }

    public static function canCreate(): bool
    {
        //return auth()->user()->hasPermissionTo('view_balabce::t::r'); // TODO: Change the autogenerated stub
        return false;
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()->hasPermissionTo('update_balabce::t::r');
    }

    public static function canDelete(Model $record): bool
    {
        return auth()->user()->hasPermissionTo('delete_balabce::t::r');
    }
