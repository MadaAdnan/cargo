...
class SuccessOrderResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return auth()->user()->hasPermissionTo('view_success::order');
    }

    public static function canCreate(): bool
    {
        return auth()->user()->hasPermissionTo('view_success::order'); // TODO: Change the autogenerated stub
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()->hasPermissionTo('update_success::order');
    }
            ...
            ->actions([
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('cancel_order')
                        ...
                        ->visible(fn($record) =>auth()->user()->hasAnyPermission(['cancel_order'])&&  $record->status !== OrderStatusEnum::SUCCESS && $record->status !== OrderStatusEnum::CANCELED && $record->status !== OrderStatusEnum::CONFIRM_RETURNED),
