...
class BalancesPendingTr extends ManageRelatedRecords
{
    protected static string $resource = UserResource::class;

    protected static string $relationship = 'balancesPendingTr';

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    public static function getNavigationLabel(): string
    {
        return 'رصيد تركي قيد التحصيل';
    }
    protected ?string $heading= 'رصيد تركي قيد التحصيل';
...
//                Tables\Actions\DeleteAction::make(),
    ...
    protected function getHeaderWidgets(): array
    {
        return array_merge(parent::getHeaderWidgets(),[
            UserResource\Widgets\BalanceView::class
