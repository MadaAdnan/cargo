...
class BalancesPendingUsd extends ManageRelatedRecords
{
    protected static string $resource = UserResource::class;

    protected static string $relationship = 'balancesPendingUsd';

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    public static function getNavigationLabel(): string
    {
        return 'رصيد دولار قيد التحصيل';
    }
    protected ?string $heading= 'رصيد دولار قيد التحصيل';
