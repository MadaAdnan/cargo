...
class PendingOrderResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return auth()->user()->hasPermissionTo('view_pending::order');
    }

    public static function canCreate(): bool
    {
        return auth()->user()->hasPermissionTo('view_pending::order'); // TODO: Change the autogenerated stub
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()->hasPermissionTo('update_pending::order');
    }
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('code')->label('QR-CODE')->searchable()->disabledClick()->copyable(),
                ...
                Tables\Columns\TextColumn::make('global_name')->label(' المستلم')->searchable()->toggleable(isToggledHiddenByDefault: false),                Tables\Columns\TextColumn::make('citySource')->label('بلدة')->formatStateUsing(fn($state) => 'من : ' . $state?->name . ' ( ' . $state?->city?->name . ' )')->description(fn($record) => "إلى : {$record->cityTarget?->name} ( {$record->cityTarget?->city?->name} )")->toggleable(isToggledHiddenByDefault: false),
