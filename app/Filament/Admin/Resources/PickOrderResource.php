...
class PickOrderResource extends Resource implements HasShieldPermissions
{
  ...
  public static function getPermissionPrefixes(): array
    ...
    protected static ?string $label = 'شحنة بالإنتظار التسليم';
...
{
    return false ;/*parent::shouldRegisterNavigation()*/; // TODO: Change the autogenerated stub
}
    public static function canAccess(): bool
    {
        return auth()->user()->hasPermissionTo('view_pick::order');
    }

    public static function canCreate(): bool
    {
        return auth()->user()->hasPermissionTo('view_pick::order'); // TODO: Change the autogenerated stub
    }

    public static function canEdit(Model $record): bool
    {
        return auth()->user()->hasPermissionTo('update_pick::order');
    }

    public static function canDelete(Model $record): bool
    {
        return auth()->user()->hasPermissionTo('delete_pick::order');
    }
