...
class BalanceEmployeeView extends BaseWidget
{
    ...
    protected function getStats(): array
    {
      ...
      return [
          Stat::make('مجموع رصيد الموظفين USD ' , HelperBalance::formatNumber($totalUsd->total)),
          Stat::make('مجموع رصيد الموظفين TRY ' ,HelperBalance::formatNumber($totalTRY->total)),
