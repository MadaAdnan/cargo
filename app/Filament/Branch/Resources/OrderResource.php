            ...
            ->actions([
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('cancel_order')
                        ...
                        ->visible(fn($record) =>auth()->user()->hasAnyPermission(['cancel_order'])&& $record->status !== OrderStatusEnum::SUCCESS && $record->status !== OrderStatusEnum::CANCELED && $record->status !== OrderStatusEnum::RETURNED && $record->status !== OrderStatusEnum::CONFIRM_RETURNED),
